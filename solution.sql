...
FROM authors LEFT JOIN distinguished_authors
ON authors.first_name = distinguished_authors.first_name WHERE award IS null;
...
SELECT * FROM employees JOIN favorite_authors
